...
namespace UnitTests.Convenience
{
    ...
    public class LatexTests
    {
        ...
        [TestMethod] public void NumPiAdd() => Test(@"3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068+3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068", numPi + numPi);
        [TestMethod] public void NumPiSubtract() => Test(@"3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068-3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068", numPi - numPi);
        [TestMethod] public void NumPiMultiply() => Test(@"3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068\times 3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068", numPi * numPi);
        [TestMethod] public void NumPiDivide() => Test(@"\frac{3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068}{3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068}", numPi / numPi);
        [TestMethod] public void NumPiPow() => Test(@"{3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068}^{x}", MathS.Pow(numPi, x));
        [TestMethod] public void PowNumPi() => Test(@"{x}^{3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068}", MathS.Pow(x, numPi));
        [TestMethod] public void MNumPiAdd() => Test(@"-3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068-3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068", mNumPi + mNumPi);
        [TestMethod] public void MNumPiSubtract() => Test(@"-3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068--3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068", mNumPi - mNumPi);
        [TestMethod] public void MNumPiMultiply() => Test(@"-3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068\times -3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068", mNumPi * mNumPi);
        [TestMethod] public void MNumPiDivide() => Test(@"\frac{-3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068}{-3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068}", mNumPi / mNumPi);
        [TestMethod] public void MNumPiPow() => Test(@"{\left(-3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068\right)}^{x}", MathS.Pow(mNumPi, x));
        [TestMethod] public void PowMNumPi() => Test(@"{x}^{-3.141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117068}", MathS.Pow(x, mNumPi));
