...
namespace UnitTests.Convenience
{
    ...
    public class FromLinqTest
    {
        ...
        public void Test1()
        {
            ...
            Assert.IsTrue(MathS.Utils.FromLinq(lambda) == MathS.Sqrt(2) * MathS.Sin(x));
        }
        [TestMethod]
        public void Test2()
        {
            ...
            var actual = MathS.Utils.FromLinq(lambda);
        ...
        public void Test3()
        {
            ...
            Assert.IsTrue(MathS.Utils.FromLinq(lambda) == x);
        }
        [TestMethod]
        public void Test4()
        {
            Expression<Func<double, double>> lambda = x => Math.Log(x, x * 3);
            Assert.IsTrue(MathS.Utils.FromLinq(lambda) == MathS.Log(x, x * 3));
        }
    }
}
