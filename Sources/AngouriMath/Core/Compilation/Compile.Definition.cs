...
namespace AngouriMath
{
    partial record Entity
    {
        ...
        public TDelegate Compile<TDelegate>(Entity expr, CompilationProtocol protocol, IEnumerable<(Type type, Variable variable)> typesAndNames) where TDelegate : Delegate
            => IntoLinqCompiler.Compile<TDelegate>(expr, protocol, typesAndNames);
    }
}