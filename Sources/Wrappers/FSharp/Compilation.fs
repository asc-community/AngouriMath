...
let compiled1In<'TIn1, 'TOut> x1 expr =
    let compiled = (parse expr).Compile<'TIn1, 'TOut>(symbol x1)
...
let compiled2In<'TIn1, 'TIn2, 'TOut> x1 x2 expr =
    let compiled = (parse expr).Compile<'TIn1, 'TIn2, 'TOut>(symbol x1, symbol x2)
...
let compiled3In<'TIn1, 'TIn2, 'TIn3, 'TOut> x1 x2 x3 expr =
    let compiled = (parse expr).Compile<'TIn1, 'TIn2, 'TIn3, 'TOut>(symbol x1, symbol x2, symbol x3)
...
let compiled4In<'TIn1, 'TIn2, 'TIn3, 'TIn4, 'TOut> x1 x2 x3 x4 expr =
    let compiled = (parse expr).Compile<'TIn1, 'TIn2, 'TIn3, 'TIn4, 'TOut>(symbol x1, symbol x2, symbol x3, symbol x4)
