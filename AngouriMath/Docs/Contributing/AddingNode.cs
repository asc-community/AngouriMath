...
///     b. then complex number evaluation (<see cref="Number.Sin"/>)
///
/// 2. Next, Add a new node representing the function as a nested type in <see cref="Entity"/>
///     a. Copy record class (Press F12 -> First result of <see cref="Sinf"/>)
...
/// 5. Expose to the user (add it to MathS, like <see cref="Sin">this</see>)
/// 
...
/// 8. Parser (if appropriate) (TODO: where's the instruction?)
/// 9. Analytical Solver (if appropriate) (Press F12 -> <see cref="TrigonometricSolver"/>
///                                and <see cref="AnalyticalSolver.Solve"/>)
