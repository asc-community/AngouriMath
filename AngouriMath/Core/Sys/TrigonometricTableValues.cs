...
namespace AngouriMath
{
    ...
    public static partial class Const
    {
        internal static class TrigonometryTableValues
        {
            ...
            private static readonly Entity f1_2 = Number.CreateRational(1, 2);
            private static readonly Entity f1_3 = Number.CreateRational(1, 3);
            private static readonly Entity f1_4 = Number.CreateRational(1, 4);
            private static readonly Entity f1_8 = Number.CreateRational(1, 8);
            ...
            /// </summary>
            private static readonly TrigTable TableSin = new TrigTable
            {
                (PiOver(1), 0),
                (PiOver(2), 0),
            ...
            private static readonly Entity f1_16 = Number.CreateRational(1, 16);

            private static readonly TrigTable TableCos = new TrigTable
            {
                (PiOver(1), 1),
                (PiOver(2), -1),
                (PiOver(3), -f1_2),
            ...
            private static readonly TrigTable TableTan = new TrigTable
            {
                (PiOver(1), 0),
                (PiOver(2), 0),
                (PiOver(3), -Sqrt(3)),
